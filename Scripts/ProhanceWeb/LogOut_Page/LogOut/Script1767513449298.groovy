...
try {
    ...
    WebUI.waitForElementPresent(findTestObject('Object Repository/Logout/logOut'), GlobalVariable.Delay)
	
    WebUI.click(findTestObject('Object Repository/Logout/logOut'), FailureHandling.STOP_ON_FAILURE)
}
catch (Exception e) {
    KeywordUtil.markError('Logout Failure : ' + e.getMessage())
}